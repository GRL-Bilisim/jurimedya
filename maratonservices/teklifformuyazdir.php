...
$sql="select * from satinalmateklifler where index_satinalmateklifler=".$_GET[teklifid];

$sorgula=mysqli_query($connection,$sql);
while($okus=mysqli_fetch_assoc($sorgula))
{
    
    $sqls = "select * from cariler where index_cariler=".$okus[ch_adi];
    $oks = mysqli_query($connection,$sqls);
    while($gels = mysqli_fetch_assoc($oks)){
        $firmaadi = iconv( "ISO-8859-9","UTF-8",$gels[firma_adi]);
        $firmatelefon = $gels[tel1];
        $firmaemail = $gels[eposta];
        $firmaadresi = iconv( "ISO-8859-9","UTF-8",$gels[fatura_adresi]);
        $firmayetkili = iconv( "ISO-8859-9","UTF-8",$gels[ilgili_kisi]);
    }
    
    $teslimsekli = iconv( "ISO-8859-9","UTF-8",$okus[teslim_sekli]);
    $odemesekli = $okus[odeme_sekli];
    $tekliftarihi = $okus[tarih];
    $toplamtutar = $okus[toplam_tutar];
    $kdv = $okus[kdv_tutar];
    $geneltoplam = $okus[genel_toplam];
    $kurtipi = $okus[kur_tipi];
    $dovizkuru = $okus[kur];
    $teslimsuresi = strtotime($okus[termin]) - strtotime($okus[tarih]);
   $teslimsuresi = floor($teslimsuresi / (60 * 60 * 24)) . " gün<br/>";


}

$getsql = "select satinalma_teklif_icerigi.*,malzemeler.malzemeaciklamasi,concat_ws('.',malzemeler.grupkodu,malzemeler.malzemekodu) as birlesik  from satinalma_teklif_icerigi left join malzemeler on malzemeler.index_malzemeler=satinalma_teklif_icerigi.ch_kodu where sip_id = ".$_GET[teklifid];
...
$malzemeadicins[$i]=iconv( "ISO-8859-9","UTF-8",$okut[malzemeaciklamasi]);
$miktar[$i]=iconv( "ISO-8859-9","UTF-8",$okut[miktar]);  
$birim[$i]=iconv( "ISO-8859-9","UTF-8",$okut[birimi]);
$birimfiyat[$i]=iconv( "ISO-8859-9","UTF-8",$okut[fiyat]);
  $tutar[$i] = $okut[miktar] * $okut[fiyat];
...
<table class=MsoTableGridLight border=0 cellspacing=0 cellpadding=0 align=left
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:2.8pt'>
  ...
  style='mso-tab-count:1'>                                         </span>TEKLİF
  İSTEME FORMU<o:p></o:p></span></b></p>
  </td>
 ...
 <tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes;height:36.8pt'>
  ...
  9.0pt;mso-bidi-font-size:11.0pt;mso-ascii-font-family:Calibri;mso-fareast-font-family:
  Calibri;mso-hansi-font-family:Calibri;mso-bidi-font-family:"Times New Roman";
  mso-fareast-language:TR;mso-no-proof:yes'>ALAZI MAHALLESİ, 31001
  <span style='mso-spacerun:yes'>   </span>ANTAKYA  /
  HATAY <span style='mso-spacerun:yes'>   </span><o:p></o:p></span></p>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal;mso-element:frame;mso-element-frame-hspace:
  7.05pt;mso-element-wrap:around;mso-element-anchor-horizontal:margin;
  mso-element-top:-53.25pt;mso-height-rule:exactly'><span style='font-size:
  9.0pt;mso-bidi-font-size:11.0pt;mso-ascii-font-family:Calibri;mso-fareast-font-family:
  Calibri;mso-hansi-font-family:Calibri;mso-bidi-font-family:"Times New Roman";
  mso-fareast-language:TR;mso-no-proof:yes'>YÜREĞİR VERGİ DAİRESİ : 742 040
  ...
  9.0pt;mso-bidi-font-size:11.0pt;mso-ascii-font-family:Calibri;mso-fareast-font-family:
  Calibri;mso-hansi-font-family:Calibri;mso-bidi-font-family:"Times New Roman";
  mso-fareast-language:TR;mso-no-proof:yes'>TELEFON : (326) 267-31-73<span
  ...
  9.0pt;mso-bidi-font-size:11.0pt;mso-ascii-font-family:Calibri;mso-fareast-font-family:
  Calibri;mso-hansi-font-family:Calibri;mso-bidi-font-family:"Times New Roman";
  mso-fareast-language:TR;mso-no-proof:yes'>FAKS : (322) 322 22 56<span
  style='mso-spacerun:yes'>   </span><o:p></o:p></span></p>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal;mso-element:frame;mso-element-frame-hspace:
  7.05pt;mso-element-wrap:around;mso-element-anchor-horizontal:margin;
  ...
  9.0pt;mso-bidi-font-size:11.0pt;mso-ascii-font-family:Calibri;mso-fareast-font-family:
  Calibri;mso-hansi-font-family:Calibri;mso-bidi-font-family:"Times New Roman";
  mso-fareast-language:TR;mso-no-proof:yes'>KEP: yetisen@hs01.kep.tr <o:p></o:p></span></p>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal;mso-element:frame;mso-element-frame-hspace:
  7.05pt;mso-element-wrap:around;mso-element-anchor-horizontal:margin;
  mso-element-top:-53.25pt;mso-height-rule:exactly'><span style='font-size:
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:22.15pt'>
  ...
  style='font-size:10.0pt;mso-bidi-font-size:11.0pt'>TESLİM ŞEKLİ<o:p></o:p></span></b></p>
  </td>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><b style='mso-bidi-font-weight:normal'><span
  style='font-size:10.0pt;mso-bidi-font-size:11.0pt'>ÖDEME ŞEKLİ<o:p></o:p></span></b></p>
  </td>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><b style='mso-bidi-font-weight:normal'><span
  style='font-size:10.0pt;mso-bidi-font-size:11.0pt'>TESLİMAT ADRESİ<o:p></o:p></span></b></p>
  </td>
    <td width=173 style='width:129.85pt;border:solid #C00000 1.0pt;border-left:
  none;mso-border-left-alt:solid #C00000 .5pt;mso-border-alt:solid #C00000 .5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:22.15pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><b style='mso-bidi-font-weight:normal'><span
  style='font-size:10.0pt;mso-bidi-font-size:11.0pt'>Teklif Tarihi<o:p></o:p></span></b></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes;height:22.1pt'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span class=SpellE><?php echo $teslimsekli; ?></span></p>
  </td>
  ...
  mso-border-alt:solid #C00000 .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:22.1pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span class=SpellE><?php echo $odemesekli; ?></span></p>
  </td>
  ...
  mso-border-alt:solid #C00000 .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:22.1pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span class=SpellE><?php echo $teslimatadresi; ?></span></p>
  </td>
    <td width=173 style='width:129.85pt;border-top:none;border-left:none;
  border-bottom:solid #C00000 1.0pt;border-right:solid #C00000 1.0pt;
  mso-border-top-alt:solid #C00000 .5pt;mso-border-left-alt:solid #C00000 .5pt;
  mso-border-alt:solid #C00000 .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:22.1pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span class=SpellE><?php echo date('d-m-Y',strtotime($tekliftarihi)); ?></span></p>
  </td>
 </tr>
</table>
...
<table class=MsoTableGridLight border=1 cellspacing=0 cellpadding=0 align=left
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:12.4pt'>
  ...
  Calibri;mso-bidi-theme-font:minor-latin;color:red'>**AŞAĞIDA BELİRTİLEN
  ÜRÜNLERİ TAM, EKSİKSİZ VE BELİRTİLEN ŞARTLARDA TEKLİF VERİLMESİNİ RİCA
  EDERİZ.**</span></b></p>
  </td>
 </tr>
 ...
 <tr style='mso-yfti-irow:2;height:19.85pt'>
  ...
  mso-element-frame-hspace:7.05pt;mso-element-wrap:around;mso-element-anchor-vertical:
  paragraph;mso-element-anchor-horizontal:margin;mso-element-top:8.6pt;
  mso-height-rule:exactly'><span lang=EN-US style='font-size:10.0pt;mso-fareast-font-family:
  "Microsoft Sans Serif";mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
  mso-ansi-language:EN-US'><span class=SpellE> <?php echo $parabirimis[0]; ?></span><o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:3;height:19.95pt'>
  ...
  mso-height-rule:exactly'><span lang=EN-US style='font-size:8.0pt;mso-fareast-font-family:
  "Microsoft Sans Serif";mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
    mso-ansi-language:EN-US'><span class=SpellE><?php echo $parabirimis[1]; ?></span><o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:4;height:19.95pt'>
  ...
  mso-height-rule:exactly'><span lang=EN-US style='font-size:8.0pt;mso-fareast-font-family:
  "Microsoft Sans Serif";mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
    mso-ansi-language:EN-US'><span class=SpellE><?php echo $parabirimis[2]; ?></span><o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:5;height:20.05pt'>
  ...
  mso-height-rule:exactly'><span lang=EN-US style='font-size:8.0pt;mso-fareast-font-family:
  "Microsoft Sans Serif";mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
    mso-ansi-language:EN-US'><span class=SpellE><?php echo $parabirimis[3]; ?></span><o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:6;height:20.05pt'>
  ...
  mso-height-rule:exactly'><span lang=EN-US style='font-size:8.0pt;mso-fareast-font-family:
  "Microsoft Sans Serif";mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
    mso-ansi-language:EN-US'><span class=SpellE><?php echo $parabirimis[4]; ?></span><o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:7;height:20.05pt'>
  ...
  mso-height-rule:exactly'><span lang=EN-US style='font-size:8.0pt;mso-fareast-font-family:
  "Microsoft Sans Serif";mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
    mso-ansi-language:EN-US'><span class=SpellE><?php echo $parabirimis[5]; ?></span><o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:8;height:20.05pt'>
  ...
  mso-height-rule:exactly'><span lang=EN-US style='font-size:8.0pt;mso-fareast-font-family:
  "Microsoft Sans Serif";mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
    mso-ansi-language:EN-US'><span class=SpellE><?php echo $parabirimis[6]; ?></span><o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:9;height:20.05pt'>
  ...
  mso-height-rule:exactly'><span lang=EN-US style='font-size:8.0pt;mso-fareast-font-family:
  "Microsoft Sans Serif";mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
    mso-ansi-language:EN-US'><span class=SpellE><?php echo $parabirimis[7]; ?></span><o:p></o:p></span></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:10;height:14.6pt'>
  <td width=983 colspan=10 valign=top style='width:737.5pt;border:none;
  ...
  color:red'>NOT:TEKNİK</span></b></span><b style='mso-bidi-font-weight:normal'><span
  style='mso-bidi-font-family:Calibri;mso-bidi-theme-font:minor-latin;
  color:red'> RESİMLER EK'TEDİR.</span></b><b style='mso-bidi-font-weight:normal'><span
 ...
 <tr style='mso-yfti-irow:11;height:15.75pt'>
  ...
  <table class=MsoTableGridLight border=1 cellspacing=0 cellpadding=0
   ...
   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:12.25pt'>
    ...
    class=SpellE><?php echo $toplamtutar; ?></span><o:p></o:p></span></p>
    </td>
    <td valign=top style='border:solid #BFBFBF 1.0pt;mso-border-themecolor:
    background1;mso-border-themeshade:191;border-left:none;mso-border-left-alt:
    solid #BFBFBF .5pt;mso-border-left-themecolor:background1;mso-border-left-themeshade:
    ...
    exactly'><span lang=EN-US style='font-size:10.0pt;mso-bidi-font-size:9.0pt;
    font-family:"Calibri",sans-serif;mso-ascii-theme-font:minor-latin;
    mso-hansi-theme-font:minor-latin;mso-bidi-font-family:"Microsoft Sans Serif"'><?php echo $kurtipi; ?><o:p></o:p></span></p>
    </td>
   </tr>
   ...
   <tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes;height:13.75pt'>
    ...
    mso-element-wrap:around;mso-element-anchor-vertical:paragraph;mso-element-anchor-horizontal:
    margin;mso-element-top:8.6pt;mso-height-rule:exactly'><o:p>&nbsp;</o:p></p>
    </td>
   </tr>
  </table>
 ...
 <tr style='mso-yfti-irow:13;height:15.75pt'>
  ...
  minor-latin'>TEKLİF İSTEYEN<o:p></o:p></span></b></p>
  </td>
  ...
  exactly'><b style='mso-bidi-font-weight:normal'><span style='font-size:9.0pt;
  mso-bidi-font-size:11.0pt;mso-bidi-font-family:Calibri;mso-bidi-theme-font:
  minor-latin'>TEKLİF VEREN<o:p></o:p></span></b></p>
  </td>
 </tr>
 <tr style='mso-yfti-irow:14;mso-yfti-lastrow:yes;height:59.6pt'>
  ...
  minor-latin;mso-fareast-language:TR;mso-no-proof:yes'><v:shape id="Resim_x0020_20"
   ...
   <img src="teklifformu_dosyalar/image002xx.png" o:title="" style='width:85.5pt;height:54pt;
