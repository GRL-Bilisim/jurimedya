                      ...
                      if($sql !== false)
{
        ...
        $sqlmn="select * from formlar where form_index=$okut[bagliform_index]";
			...
			**/
            ...
            // üretim emirleri formundaki üretim paletleri tablosunda o üretime ait lot no gelmesi olayı.
            if($_GET['formid']=='642' && $_GET['p1']!=''){
                $parm1 = $_GET['p1'];
                $eksorgu = " and sarjgirdileri.uretimid='$parm1' ";
                $sorgu= $sorgu.' '.$eksorgu;
            }
                           ...
                           if ($okut[verigiristuru]=='Combobox')
            {
              ...
              if($sqlmn !=='false'){
                  while($okubeni=$sqlmn->fetch(PDO::FETCH_ASSOC)){
                      ...
                      if ($okut[eksorgu]!='')
                      {
                            $sorgu=$sorgu." and ".str_replace("#", "'", $okut[eksorgu]); 
                      }
