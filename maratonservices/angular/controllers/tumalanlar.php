...
**/    
         ...
         $sqlys=$db->prepare("select * from formalanlari where formalanlari.form_index=?  and deleted='false' order by formalanlari.alansirasi asc");
