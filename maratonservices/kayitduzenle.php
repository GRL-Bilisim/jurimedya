 ...
 <!-- End .panel -->
							...
							<div id="kayitformuicerik">
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST" name="satirdetayformu" id="satirdetayformu" action="" enctype="multipart/form-data">
...
if ($formid!='126')
{
    ...
    $alanim=$ykn[detailfield];
					...
					echo "<td><button style=\"margin-left:5px\" type=\"button\" class=\"btn btn-danger tip2\" title=\"Sil\" id=\"recordid=".$icerigi[$anahtar2]."&menu_id=$ozelformid\"><font size=\"1\">Sil</font></button></td>";
}
...
<?php echo $etiketi.":" ?><input type="date" style="min-width:180px;"  id="<?php echo $met[alanadi]; ?>" name="<?php echo $met[alanadi]; ?>"  class="form-control" placeholder="<?php echo $etiketi; ?>" value="<?php echo iconv( "ISO-8859-9","UTF-8",$varsayilan); ?>" <?php echo $ekkod; ?>>
...
<div class="input-group mb-15"> 
														<input type="text" name="<?php echo $met[alanadi]; ?>" id="<?php echo $met[alanadi]; ?>" class="form-control" placeholder="Seçiniz" value="<?php echo iconv( "ISO-8859-9","UTF-8",$varsayilan); ?>" <?php echo $ekkod; ?>><span class="input-group-btn" >
...
<div <?php echo $boyut; ?>>
	...
	<?php 		                                             if ($met[zorunlu]=='True')
																...
																<?php echo $etiketi.":" ?><select class="custom-select form-control" name="<?php echo $met[alanadi]; ?>" id="<?php echo $met[alanadi]; ?>"  data-placeholder="<?php echo $etiketi; ?>" tabindex="1" <?php echo $ekkod; ?>>
