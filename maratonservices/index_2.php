								...
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											...
											<h6 class="text-center nonecase-font txt-grey">YETİŞEN KAUÇUK</h6>
										</div>	
										<div class="form-wrap">
...

{
	...
	echo "<input  id='".$met[alanadi]."' name='".$met[alanadi]."' type=\"hidden\" value=\"".iconv( "ISO-8859-9","UTF-8",$varsayilan)."\">";
...
<?php echo $etiketi.":" ?><input type="<?php echo $type; ?>" id="<?php echo $met[alanadi]; ?>" name="<?php echo $met[alanadi]; ?>"  class="form-control" placeholder="<?php echo $etiketi; ?>" value="<?php echo iconv( "ISO-8859-9","UTF-8",$varsayilan); ?>">
...
<div class="input-group mb-15"> 
														...
														<button type="button" class="btn  btn-warning secimyap" title="<?php echo $met[bagliform_index]; ?>_<?php echo $met[keyfield]; ?>_<?php echo $met[alanadi]; ?>"><i class="fa fa-search"></i></button>
														</span>
													</div>
...
<div <?php  echo $boyut;?>>
															...
															<div <?php echo $id; ?>  class="row" >
																...
																</select></div><div class="col-md-2"><button type="button" class="btn btn-warning btn-icon-anim btn-square verisec" style="margin-left:-14px;" title="<?php echo $met[bagliform_index]; ?>_<?php echo $alanadi; ?>_<?php echo $met[alanadi]; ?>"><i class="icon-rocket"></i></button></div>
...
mysqli_query($connection,"update sabitkm set tarih='".$oncekigun."',km='".$gezilen."' where plakano='".$_GET[plakano]."'");
	...
	if ($met[varsayilan]=='ustformid'||$met[varsayilan]=='mastervalue')
...
<?php echo $etiketi.":" ?><input type="<?php echo $type; ?>" title="<?php echo $etiketi; ?>" id="<?php echo $met[alanadi]; ?>" name="<?php echo $met[alanadi]; ?>"  class="form-control" placeholder="<?php echo $etiketi; ?>" value="<?php echo iconv( "ISO-8859-9","UTF-8",$varsayilan); ?>" <?php echo $required;?>>
...
<?php echo $etiketi.":" ?><input type="time" title="<?php echo $etiketi; ?>" id="<?php echo $met[alanadi]; ?>" name="<?php echo $met[alanadi]; ?>"  class="form-control" placeholder="<?php echo $etiketi; ?>" value="<?php echo iconv( "ISO-8859-9","UTF-8",$varsayilan); ?>" <?php echo $required;?>>
											...
											?>
												<tr>
													...
													<td><a href="index.php?page_id=design&tasarimid=<?php echo $_GET[tasarimid]; ?>&blokid=<?php echo $okut[bokindex]; ?>"><?php echo $button; ?></a>
													  ...
													  <a href="#" class="satirduzelt" title="<?php echo iconv( "ISO-8859-9","UTF-8","200_".$okut[bokindex]); ?>" data-original-title="Değiştir"><button class="btn btn-default btn-icon-anim btn-square"><i class="fa fa-pencil"></i></button></a>
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body row pa-0">
										<table class="table table-hover mb-0" id="example1">
											...
											<?php
											$sql="select * from formalanlari where form_index=".$_GET[tasarimid]." order by alan_index";
											$sorgula=mysqli_query($connection,$sql);
											while($okut=mysqli_fetch_assoc($sorgula))
											{
											?>
												<tr class="active">
													...
													<td>
													    		    		  ...
													    		    		  <a href="#" class="satirduzelt" title="<?php echo iconv( "ISO-8859-9","UTF-8","199_".$okut[alan_index]); ?>" data-original-title="Değiştir"><button class="btn btn-default btn-icon-anim btn-square"><i class="fa fa-pencil"></i></button></a>
                                                <a href="#" title="<?php echo iconv( "ISO-8859-9","UTF-8",$okut[alan_index]); ?>" class="formalansil" data-original-title="Sil"><button class="btn btn-danger btn-icon-anim btn-square"><i class="icon-trash"></i></button></a>
													    ...
													    <a href="#aktarimyap" class="aktarimyap" title="<?php echo $okut[alan_index]; ?>"><button class="btn btn-primary btn-icon-anim btn-square " title="<?php echo $okut[alan_index]; ?>"><i class="icon-arrow-right"></i></button></a></td>
												</tr>
											<?php
											}
											?>
											...
											?>
												<tr class="active">
													...
													<td><a href="#alansil" class="alansil" title="<?php echo $okut[altindex]; ?>"><button class="btn btn-danger btn-icon-anim btn-square" title="<?php echo $okut[altindex]; ?>"><i class="icon-trash"></i></button></a>
															    		    		  <a href="#" class="satirduzelt" title="<?php echo iconv( "ISO-8859-9","UTF-8","236_".$okut[altindex]); ?>" data-original-title="Değiştir"><button class="btn btn-default btn-icon-anim btn-square"><i class="fa fa-pencil"></i></button></a>
...
if ($_GET[menu_id]=='199')
{
    ...
    echo "</select><br>";
            ...
            ?>    										
									...
									<div class="row col-md-12" style="left:75%;">
												...
												<a href="#" class="sqlcalistir" data-original-title="Tasarla"><button class="btn btn-danger btn-icon-anim btn-square"><i class="icon-control-play"></i></button></a>
...
$sorsana=mysqli_query($connection,iconv( "UTF-8","ISO-8859-9",$sorgusu).$filtre.$grup);		
...
?>
  ...
  <a href="index.php?page_id=editrecord&menu_id=<?php echo $_GET[menu_id]; ?>&recordid=<?php echo $okun[$anahtars]; ?>" title="" data-original-title="Değiştir"><button class="btn btn-default btn-icon-anim btn-square"><i class="fa fa-pencil"></i></button></a>
   ...
   <a href="#" title="form_<?php echo $_GET[menu_id]; ?>_recordid_<?php echo $okun[$anahtars]; ?>"  title="kopyala" class="kopyala"><button class="btn btn-warning btn-icon-anim btn-square"><i class="icon-layers"></i></button></a>
...
<?php
		...
		?>
			...
			<footer class="footer container-fluid pl-30 pr-30">
				<div class="row">
					<div class="col-sm-12">
						<p>2020 &copy; Circle360, HATAY, YETİŞEN KAUÇUK</p>
					</div>
				</div>
			</footer>
			<!-- /Footer -->
...
var id=this.title;
 ...
 if (confirm('Tüm alanlar aktarılsın mı?')) 
    {
      ...
      contentType: false,
	   ...
	   success: function(data)

           {
			 ...
			 if (data=='OK')
			 {
			     alert('Kodunuz başarıyla çalıştırıldı');
			 }
...
var id=this.title;
 ...
 if (confirm('Veri alanı silinsin mi?')) 
    {
...
if (res[0]!='236')
{
      ...
      url: 'yenikayit.php?page_id=yenikayit&menu_id='+titles+'&mastervalue='+ustform,
...
else
{
  ...
  $.ajax( {
      ...
      url: 'tablogetir.php?menu_id='+res[0]+'&verialani='+res[1],
     ...
     $('#tablosecimicerik').html(data);
      ...
      url: 'tablogetir.php?menu_id='+res[0]+'&verialani='+res[1]+'&coklusecim=E',
...
$( "#kayitbasarili" ).hide( "slow", function() {
  ...
  $(document).on("click",".kopyala",function(){
          ...
          if (confirm('Satırı kopyalamak istediğinizden emin misiniz?')) 
    {
...
var id=this.title;
      ...
      url: 'kopyala.php?menu_id='+res[1]+'&recordid='+res[3],
...
?>
 ...
 <?php
  ...
  ?>
      ...
      $("#example1").on("click",".tip",function(){
