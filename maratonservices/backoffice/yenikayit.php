...
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							...
							<div id="kayitformuicerik">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST" name="satirdetayformu" id="satirdetayformu" action="sender.php?form_id=<?php 
...
if ($_GET["kurumid"]!='')
{
...

	{
		...
		if ($met[varsayilan]=='mastervalue')

	{
	     $varsayilan=$_GET[mastervalue];
...
<div <?php echo $boyut; ?>">	  
                                                    ...
                                                    <label class="toggle" data-on="ON" data-off="OFF">
                                                        ...
                                                        <input type="checkbox" id="<?php echo $met[alanadi]; ?>" name="<?php echo $met[alanadi]; ?>">
...
<?php echo $etiketi.":" ?><div class="fileinput fileinput-new" data-provides="fileinput">
													...
													<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px; line-height: 150px;"><a href="<?php echo $varsayilan; ?>" data-toggle="lightbox" data-gallery="gallerymode" data-title="Yachts" data-parrent=""><img style="max-width:100%;max-height:150px" src="<?php echo $varsayilan; ?>" id="resim_<?php echo $met[alanadi]; ?>"></a></div>
...
<?php echo $etiketi.":" ?><input type="date" style="min-width:180px;" id="<?php echo $met[alanadi]; ?>" title="<?php echo $etiketi; ?>" name="<?php echo $met[alanadi]; ?>"  class="form-control" placeholder="<?php echo $etiketi; ?>" value="<?php echo iconv( "ISO-8859-9","UTF-8",$varsayilan); ?>">
