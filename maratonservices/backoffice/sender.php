...
if ($okusana[verigiristuru]!='Date'&&$okusana[verigiristuru]!='Secimli')


{


$valuesorgusu="'".iconv( "UTF-8","ISO-8859-9",degistir(mysqli_real_escape_string($_POST[$alanadi])))."'";
...
$updatesorgusu="SET $alanadi='".iconv( "UTF-8","ISO-8859-9",mysqli_real_escape_string($_POST[$alanadi]))."'";

if ($alanadi=='mesaj'&&$_GET[form_id]=='53')
{

$updatesorgusu="SET $alanadi='".iconv( "UTF-8","ISO-8859-9",mysqli_real_escape_string($_POST[$alanadi]))." ".$_SESSION["adi"]."'";
}
...
if ($okusana[verigiristuru]=='Secimli')
	 ...
	 for($i=0;$i<count($_POST[$alanadi]);$i++)
{
	  ...
	  if ($i>0)
	 {
	     if (mysqli_real_escape_string($_POST[$alanadi][$i])!='')
	     {
		 $verisi=$verisi.";".mysqli_real_escape_string($_POST[$alanadi][$i]); 
	     }
	 }
	 
	 if ($i==0)
	 {
    $verisi=mysqli_real_escape_string($_POST[$alanadi][$i]);
	 }
...
$valuesorgusu="'".iconv( "UTF-8","ISO-8859-9",degistir($verisi))."'";
...
$updatesorgusu="SET $alanadi='".iconv( "UTF-8","ISO-8859-9",degistir($verisi))."'";
...
$valuesorgusu=$valuesorgusu.",'".iconv( "UTF-8","ISO-8859-9",mysqli_real_escape_string($_POST[$alanadi]))."'";
}

if ($alanadi=='mesaj'&&$_GET[form_id]=='53')
{
$valuesorgusu=$valuesorgusu.",'".iconv( "UTF-8","ISO-8859-9",mysqli_real_escape_string($_POST[$alanadi]))." ".$_SESSION["adi"]."'";
...
$updatesorgusu=$updatesorgusu.','."$alanadi='".iconv( "UTF-8","ISO-8859-9",mysqli_real_escape_string($_POST[$alanadi]))."'";
...
$verisi="";
  ...
  $valuesorgusu=$valuesorgusu.",'".iconv( "UTF-8","ISO-8859-9",degistir($verisi))."'";
}
...
$valuesorgusu=$valuesorgusu.",'".iconv( "UTF-8","ISO-8859-9",degistir(mysqli_real_escape_string($_POST[$alanadi])))."'";
...
$updatesorgusu=$updatesorgusu.','."$alanadi='".iconv( "UTF-8","ISO-8859-9",degistir(mysqli_real_escape_string($_POST[$alanadi])))."'";
...
$den="show table status from megacarss where name='$oku[tablosu]'";
...
$sqlm="insert into kullaniciloglari values('',".$_SESSION["user_id"].",'$tarih','$zaman','$oku[formtanimi]','Yeni Kayıt',$kaym,'')";
...
$sqlm="insert into kullaniciloglari values('',".$_SESSION["user_id"].",'$tarih','$zaman','$oku[formtanimi]','Güncelleme',$kayitid,'')";
