...
$title="Circle360 | ENTERPRISE RESOURCE PLANNING";
								...
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											...
											<h6 class="text-center nonecase-font txt-grey">ENTERPRISE RESOURCE PLANNING</h6>
										</div>	
										<div class="form-wrap">
										...
										<table class="table table-hover mb-0">
											...
											?>
												<tr class="active">
													...
													<td><a href="#aktarimyap" class="aktarimyap" title="<?php echo $okut[alan_index]; ?>"><button class="btn btn-primary btn-icon-anim btn-square " title="<?php echo $okut[alan_index]; ?>"><i class="icon-arrow-right"></i></button></a></td>
												</tr>
											<?php
											}
											?>
										...
										<table class="table table-hover mb-0">
											...
											?>
												<tr class="active">
													...
													<td><?php echo iconv( "ISO-8859-9","UTF-8",$okut[alanyazisi]); ?></td>
													<td><?php echo $okut[alanadi]; ?></td>
													<td><a href="#alansil" class="alansil" title="<?php echo $okut[altindex]; ?>"><button class="btn btn-danger btn-icon-anim btn-square" title="<?php echo $okut[altindex]; ?>"><i class="icon-trash"></i></button></a></td>
												</tr>
											<?php
											}
											?>
...
if ($_GET[menu_id]=='199')
{
    ...
    echo "</select><br>";
            ...
            ?>    										
									...
									<div class="row col-md-12" style="left:80%;">
...
?>
		...
		echo " <div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\"><h6 class=\"txt-dark capitalize-font\"><i class=\"zmdi zmdi-account mr-10\"></i>".iconv( "ISO-8859-9","UTF-8",$okut[menutanimi])."</h6>";
		...
		?>
			...
			<footer class="footer container-fluid pl-30 pr-30">
				<div class="row">
					<div class="col-sm-12">
						<p>2020 &copy; Circle360, Hatay, Yetişen Kauçuk</p>
					</div>
				</div>
			</footer>
			<!-- /Footer -->
...
$('#exampleModalLabel').html('Düzelt');
   ...
   $('#yenisatirModal_'+res[1]).modal('show');
    ...
    $( ".satirduzelt" ).on('click',function(){
      ...
      url: 'kayitduzenle.php?page_id=kayitduzenle&menu_id='+res[0]+'&mastervalue=<?php echo $_GET[recordid]; ?>&kayitid='+res[1],
