            ...
            foreach ($Reader as $Row)
            {
              ...
              $deger='';
                ...
                for ($t=0;$t<count($dilimler);$t++)
                {
                    ...
                    $sqlyes="select * from formalanlari where alanadi='".$dilimler[$t]."' and form_index=".$_GET['menu_id'];
 ...
 while($okut=mysqli_fetch_assoc($sorgulama))
 {
     ...
     if ($okut[verigiristuru]=='Date')
    {
                ...
                if(isset($Row[0])&&$j>0) {
                    ...
                    $query = "insert into $tablosu($excelimport,$masteralan) values(".iconv( "UTF-8","ISO-8859-9",$deger).",'".$mastervalue."')";
                    ...
                    $query = "insert into $tablosu($excelimport) values(".iconv( "UTF-8","ISO-8859-9",$deger).")";
