 ...
 if ($_GET[page_id]=='login')
    {
     ...
     include 'baglanti.php';
      $sqlys="select * from kullanicilar where username='".$_GET[username]."' and pass='".$_GET[password]."'";
...

{
 ...
 $filtre=$filtre." and bildirimsahibi='".$_GET[uid]."' ";   
}


if($_GET[tedi]!='' && $_GET[tedi]!='undefined'){
    
 $filtre=$filtre." and malzemeid='".$_GET[tedi]."' "; 
}
