...
var durum = this;
  ...
  durusOlustur(id) {
    ...
    swal.fire({
      ...
      if (result.value) {
        const durusOlustur = localStorage.getItem('url') +"angular/dataservis.php?page_id=durusbaslat&baslat=E&isemriid=" + durum.eId + "&duruskodu=" + id + "&personelid=" + durum.perId;
