...
export const Full_ROUTES: Routes = [
  ...
  {
    path: 'newrecordform/:formid/:formtanimi/:token',
  ...
  {
    path: 'app-alt',
    loadChildren: () => import('../../alttable/alt.module').then(m => m.AltModule)
  },
  {
    path: 'barcodeform',
  ...
  {
    path: 'urunagaci/:urunid',
    loadChildren: () => import('../../urunagaci/urunagaci.module').then(m => m.urunagaciModule)
  },
  {
    path: 'ganttchart',
