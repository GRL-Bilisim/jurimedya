            ...
            swal.fire({
              ...
              if (result.value) { 
                ...
                for (let i = 0; i < durum.tabloSecililer.length; i++) {
                  ...
                  const girdikal=localStorage.getItem('url') + "angular/dataservis.php?page_id=girdikabulicerik&imt="+imt+"&satinalno="+satinalmano+"&adet="+adet+"&sipariskg="+sipariskg+"&master="+master+"&userid="+localStorage.getItem('userid')+"&indexsa="+insatinalma;
