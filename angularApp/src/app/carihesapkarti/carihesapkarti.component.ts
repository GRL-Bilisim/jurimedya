...
import { ChatService } from './carihesapkarti.service';
import { Chat, UsersChat } from './carihesapkarti.model';
...
@Component({
  selector: 'app-carihesapkarti',
  templateUrl: './carihesapkarti.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  styleUrls: ['./carihesapkarti.component.scss'],
